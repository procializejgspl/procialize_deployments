...
set :scm, "git"
set :branch, "procialize_diemould_new"
set :deploy_via, :remote_cache

set :application, "Procialize_diemould"
...
role :app, "146.185.177.206"
role :web, "146.185.177.206"
role :db, "146.185.177.206", :primary => true
