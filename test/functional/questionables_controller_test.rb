...
class QuestionablesControllerTest < ActionController::TestCase
  ...
  test "should create questionable" do
    assert_difference('Questionable.count') do
      post :create, questionable: { approved: @questionable.approved, event_id: @questionable.event_id, likes: @questionable.likes, quest_name: @questionable.quest_name, user_id: @questionable.user_id }
    end
  ...
  test "should update questionable" do
    put :update, id: @questionable, questionable: { approved: @questionable.approved, event_id: @questionable.event_id, likes: @questionable.likes, quest_name: @questionable.quest_name, user_id: @questionable.user_id }
    assert_redirected_to questionable_path(assigns(:questionable))
  end
