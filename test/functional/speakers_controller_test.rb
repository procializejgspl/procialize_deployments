...
class SpeakersControllerTest < ActionController::TestCase
  ...
  test "should create speaker" do
    assert_difference('Speaker.count') do
      post :create, speaker: { name: @speaker.name, speaker_details: @speaker.speaker_details, speaker_pic: @speaker.speaker_pic, user_id: @speaker.user_id }
    end
  ...
  test "should update speaker" do
    put :update, id: @speaker, speaker: { name: @speaker.name, speaker_details: @speaker.speaker_details, speaker_pic: @speaker.speaker_pic, user_id: @speaker.user_id }
    assert_redirected_to speaker_path(assigns(:speaker))
  end
